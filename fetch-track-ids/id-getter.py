...
try:
    while artist_queue and (len(track_ids) < ((2 ** 17) + 2)):
        ...
        offset = 0
        while True:
            album_batch = api_request_manager.send_request(request=api_request_manager.sp.artist_albums,
                                                           artist_id=artist_id, limit=50, offset=offset)
